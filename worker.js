...
// This is more reliable across different browsers and server environments like GitHub Pages.
try {
    importScripts(
    ...
    // If scripts fail to load, the worker is useless. We can post an error back.
...
// We need to alias them for easier use.
...
async function initialize() {
    // Check if the libraries were loaded successfully
